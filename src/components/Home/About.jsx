...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Took my in to have my air con looked out. They diagnosed and fixed the problem quickly and sent me a text to let me know my car was ready. Very happy with the service will definitely use them again.",
    name: "Andrew Jones",
  },
